...
OBJECTS= build/game.o build/entity.o build/creature.o build/player.o build/world.o build/tile.o build/object.o build/npc.o
...
build/entity.o: src/entity.cpp include/entity.hpp build/tile.o
...
build/world.o: src/world.cpp include/world.hpp build/player.o
