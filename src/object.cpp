...
Object::Object(sf::RenderWindow* window, int width, int height, int x, int y, int mass, std::string type, std::map<int, std::map<int, Entity*>>* entitymap) : Entity(window, width, height, x, y, entitymap) {
	this->type = type;
